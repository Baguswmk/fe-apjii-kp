...
const Hero = () => {
  ...
  return (
    <div className="home relative bg-gradient-to-b mb-44  " style={{ backgroundImage: "linear-gradient(to bottom, #215385, #000000)", height: "calc(100vh - 105px)" }}>
      <motion.div
        className="home-bg absolute right-0 bottom-0 z-0 mr-[51px] max-md:mr-[50px] xl:w-[50%]"
        animate={{ x: 50 }}
        transition={{
          ease: "linear",
          duration: 0.5,
      ...
      >
        <img src={globe} alt="image-globe" className="  2xl:w-[100%] xl:w-[85%] xl:ml-auto max-h-[60rem] lg:w-[70%]" />
      </motion.div>
      ...
      >
        <img src={apjii} alt="image-globe" className="w-full max-h-[40rem] xl:w-[70%] xl:ml-auto" />
      </animated.div> 
